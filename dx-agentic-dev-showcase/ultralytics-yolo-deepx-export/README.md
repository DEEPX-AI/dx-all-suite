...
<td align="center"><img src="../../docs/source/img/dx-agentic-dev-ultralytics-build.gif" width="430"><br><sub><b>dx-agentic-dev building this showcase (timelapse) — export → dx_com compile → NPU inference → verify</b></sub></td>
<td align="center"><video src="../../docs/source/img/dx-agentic-dev-ultralytics-yolo.mp4" width="360" controls muted loop playsinline poster="../../docs/source/img/dx-agentic-dev-ultralytics-yolo-poster.jpg"></video><br><sub><b>DEEPX × Ultralytics — YOLO on the DX-M1 NPU (partner demo)</b></sub></td>
</tr></table></div>
...
4. **`/dx-agentic-compiler-convert` Phase 0** → recognises a YOLO **detection** model
