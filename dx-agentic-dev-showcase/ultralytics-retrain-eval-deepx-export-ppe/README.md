...
<td align="center"><img src="../../docs/source/img/dx-agentic-dev-ultralytics-ppe-build.gif" width="470"><br><sub><b>dx-agentic-dev building this showcase (timelapse)</b></sub></td>
...
- **Domain retraining**: mAP50-95 **0.0001 → ~0.26** (stock can't detect PPE at all).
- **INT8 ≈ fp32**: retrained fp32 0.2515 vs DX-M1 INT8 0.2566 — DeepX EMA calibration lossless here.
- **Domain model faster on the NPU**: 57.9 → **79.7 FPS** (smaller head than stock nc=80).
...
Agent-generated: `train.py`, `export_eval.py`, `make_report.py`, `verify.py`. Binaries +
`runs/` regenerated, not committed.
