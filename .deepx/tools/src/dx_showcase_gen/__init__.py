"""dx-showcase-gen — deterministic mechanics for building dx-agentic-dev showcases.

Pairs with the RIGID skill ``dx-agentic-showcase-build`` (which orchestrates the
