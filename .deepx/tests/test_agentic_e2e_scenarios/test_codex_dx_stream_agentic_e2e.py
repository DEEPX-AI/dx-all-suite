...
"""
Agentic E2E Test (Codex): dx_stream Scenario — Detection Pipeline with Tracking
...
This is the Codex counterpart of ``test_dx_stream_agentic_e2e.py`` (Copilot CLI)
...
class TestExecution:
    ...
    def test_completed_within_timeout(self, scenario: ScenarioResult):
        ...
        assert scenario.duration_seconds < DEFAULT_CODEX_TIMEOUT + 10, (
            f"Scenario took {scenario.duration_seconds:.0f}s (limit: {DEFAULT_CODEX_TIMEOUT}s)"
        )
