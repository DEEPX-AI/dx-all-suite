...
This is the Codex counterpart of ``test_suite_agentic_e2e.py`` (Copilot CLI)
...
SUITE_TIMEOUT = 3000  # R19: increased from 2400 — codex brainstorm+prereq+compile+app cycle needs 50 min budget
