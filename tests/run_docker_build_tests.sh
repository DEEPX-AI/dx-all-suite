...
#
# Examples:
#   ./run_docker_build_tests.sh                          # Run all tests
#   ./run_docker_build_tests.sh -k sanity                # Run only sanity tests
#   ./run_docker_build_tests.sh -k "runtime and 24.04"   # Run specific tests
#   ./run_docker_build_tests.sh --collect-only           # List all tests
