...
> **Note:** For agent-driven development tests (conformance, test_agentic_e2e_scenarios), see [`.deepx/tests/README.md`](../.deepx/tests/README.md).

## ✅ Test Suite Categories

This repository includes three pytest suites for CI/CD and local validation:
...
| **Full Suite (all)** | 78 | ~15-21 hours | Complete validation |
