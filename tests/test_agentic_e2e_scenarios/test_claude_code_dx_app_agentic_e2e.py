...
"""
Agentic E2E Test (Claude Code): dx_app Scenario — Build a Python Detection App
...
This is the Claude Code counterpart of ``test_dx_app_agentic_e2e.py`` (Copilot CLI)
