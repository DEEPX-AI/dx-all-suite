...
| **[Ultralytics brain-tumor → DeepX NPU](../../dx-agentic-dev-showcase/ultralytics-braintumor-deepx/)** | Retrains `yolo26n` for MRI/CT brain-tumor screening, 4-way eval; stock mAP ~0.0005 → 0.40, +34% NPU FPS | ≈ 12 min | — | — | ≈ $5 |
| **[Ultralytics pill → DeepX NPU](../../dx-agentic-dev-showcase/ultralytics-pills-deepx/)** | Retrains `yolo26n` for pharma pill detection, 4-way eval; stock mAP ~0.001 → 0.75 (mAP50 0.97), +38% NPU FPS | ≈ 9 min | — | — | ≈ $4 |
